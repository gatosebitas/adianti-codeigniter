...
class AdiantiCoreTranslator
{
	...
	*/
	private function __construct()
	{
		...
		$this->messages['es'][] = 'Registros excluídos';
		...
		$this->messages['es'][] = 'Excluir selecionados';
		...
		$this->messages['es'][] = 'Campo para a ação ^1 não definido';
		$this->messages['es'][] = 'Campo ^1 não existe ou contém valor NULL';
		$this->messages['es'][] = 'Use o método ^1';
		$this->messages['es'][] = 'Formulário sem campos';
		$this->messages['es'][] = 'E-mail não enviado';
		...
		$this->messages['es'][] = 'O campo ^1 deve ser numérico';
		$this->messages['es'][] = 'Sem transação ativa com a base de dados';
		$this->messages['es'][] = 'Objeto não encontrado';
		$this->messages['es'][] = 'Objeto ^1 não encontrado em ^2';
		$this->messages['es'][] = 'Método ^1 não aceita valores NULOS';
		$this->messages['es'][] = 'Método ^1 deve receber um parâmetro do tipo ^2';
		$this->messages['es'][] = 'Estilo ^1 não encontrado em ^2';
		$this->messages['es'][] = 'Você deve executar o construtor de ^1';
		$this->messages['es'][] = 'Você deve executar ^1 antes de ^2';
		$this->messages['es'][] = 'Você deve passar o ^1 (^2) como parâmetro para ^3';
		$this->messages['es'][] = 'O parâmetro (^1) de ^2 é obrigatório';
		$this->messages['es'][] = 'O parâmetro (^1) do construtor de ^2 é obrigatório';
		$this->messages['es'][] = 'Você já adicionou um campo chamado "^1" ao formulário';
		$this->messages['es'][] = 'Fechar a aplicação ?';
		$this->messages['es'][] = 'Use addField() ou setFields() para definir os campos do formulário';
		$this->messages['es'][] = 'Verifique se a ação (^1) existe';
		$this->messages['es'][] = 'Informação';
		$this->messages['es'][] = 'Erro';
		$this->messages['es'][] = 'Exceção';
		$this->messages['es'][] = 'Questão';
		$this->messages['es'][] = 'A classe ^1 não foi aceita como argumento. O parâmetro deve ser subclasse de ^2.';
		$this->messages['es'][] = 'A classe ^1 não foi aceita como argumento. O parâmetro deve implementar ^2.';
		$this->messages['es'][] = 'A classe ^1 não foi encontrada. Verifique o nome da classe ou do arquivo. Eles devem coincidir';
		$this->messages['es'][] = 'Nome de propriedade reservado (^1) na classe ^2';
		$this->messages['es'][] = 'A ação (^1) deve ser estática para ser usada em ^2';
		$this->messages['es'][] = 'Tentativa de acesso à uma propriedade não existente (^1)';
		$this->messages['es'][] = 'Formulário não encontrado. Verifique se você passou o campo (^1) para o setFields()';
		$this->messages['es'][] = 'Classe ^1 não encontrada em ^2';
		$this->messages['es'][] = 'Você deve executar ^1 antes de adicionar o componente';
		$this->messages['es'][] = 'Driver não encontrado';
		$this->messages['es'][] = 'Buscar registro';
		$this->messages['es'][] = 'Campo';
		$this->messages['es'][] = 'Registro atualizado';
		$this->messages['es'][] = 'Registros atualizados';
		$this->messages['es'][] = 'Entrada';
		$this->messages['es'][] = 'Classe ^1 não encontrada';
		$this->messages['es'][] = 'Método ^1 não encontrado';
		$this->messages['es'][] = 'Verifique o nome da classe ou do arquivo';
		$this->messages['es'][] = 'Limpar';
		$this->messages['es'][] = 'Selecionar';
		$this->messages['es'][] = 'Você deve definir o campo para a ação (^1)';
		$this->messages['es'][] = 'A seção (^1) não foi fechada adequadamente';
		$this->messages['es'][] = 'O método ^1 somente aceita valores do tipo ^2 entre ^3 e ^4';
		$this->messages['es'][] = 'A classe interna ^1 não pode ser executada';
		$this->messages['es'][] = 'A versão mínima requerida para o PHP é ^1';
		$this->messages['es'][] = '^1 não definido. Você deve executar ^2 no ^3';
		$this->messages['es'][] = 'Database';
		$this->messages['es'][] = 'Construtor';
